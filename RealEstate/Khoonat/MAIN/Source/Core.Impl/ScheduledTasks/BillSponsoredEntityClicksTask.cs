...
{
    [Component]
    public class BillSponsoredEntityClicksTask : ScheduledTaskBase
    {
        private static readonly ILog Log = LogManager.GetLogger(typeof(BillSponsoredEntityClicksTask));
        ...
        {
            get { return ScheduledTaskKeys.BillSponsoredEntityClicksTask; }
        }
        ...
        {
            var thereIsMoreWorkToDo = SponsoredEntityService.BillClicks();
