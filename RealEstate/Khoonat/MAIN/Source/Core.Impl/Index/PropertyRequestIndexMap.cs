...
namespace JahanJooy.RealEstate.Core.Impl.Index
{
	...
	[Component]
	[ComponentCache(null)]
	public class PropertyRequestIndexMap : ObjectIndexMapperBase<PropertyRequest>
	{
		...
		[ComponentPlug]
		public IEntityContentSerializer<PropertyRequestContent> PropertyRequestContentSerializer { get; set; }

		private readonly NumericField _idField;

		public PropertyRequestIndexMap()
		{
			//
			// Initialize fields
		...
		protected override void SetFieldValues(PropertyRequest request)
		{
			PropertyRequestContentSerializer.DeserializeIfNeeded(request);
