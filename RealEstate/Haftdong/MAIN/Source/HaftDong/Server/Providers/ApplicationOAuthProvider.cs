...
namespace JahanJooy.RealEstateAgency.HaftDong.Server.Providers
{
    [Contract]
    [Component]
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        {
            _publicClientId = "jj.realestateagency";
        }
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            if (context.UserName.IsNullOrEmpty() || context.Password.IsNullOrEmpty())
            {
