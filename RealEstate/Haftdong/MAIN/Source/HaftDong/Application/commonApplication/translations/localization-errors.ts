module JahanJooy.HaftDong {
    ...
    [
        ...
        { key: "Contract_Print_UnexpectedError", text: "در چاپ قرارداد خطای نامشخصی رخ داده است" },
    ...
    [
        ...
        { key: "Supply_ContactInfo_ValueNotSpecified", text: "اطلاعات تماس مشخص نشده است" },
        ...
        { key: "Supply_Phones_ValueNotSpecified", text: "برای آگهی کردن این ملک حداقل باید یک شماره تماس ثبت شود" }
    ]);

    Common.localization.addErrorTranslations(null,
    [
        { key: "Request_UnexpectedError", text: "خطای نامشخصی رخ داده است" },
        { key: "Request_Print_UnexpectedError", text: "در چاپ درخواست خطای نامشخصی رخ داده است" },
        ...
        { key: "Request_ContactInfo_ValueNotSpecified", text: "اطلاعات تماس درخواست مورد نظر مشخص نشده است" },
        ...
        { key: "Request_Phones_ValueNotSpecified", text: "برای آگهی کردن این درخواست حداقل باید یک شماره تماس ثبت شود" }
    ]);
    ...
    Common.localization.addErrorTranslations(null,
    [
        { key: "Customer_UnexpectedError", text: "خطای نامشخصی رخ داده است" },
        { key: "Customer_State_IsNotValid", text: "وضعیت مشتری مورد نظر معتبر نیست" },
        { key: "Customer_NotFound", text: "مشتری مورد نظر یافت نشد" },
        { key: "Customer_NotModified", text: "مشتری مورد نظر ویرایش نشد" },
        { key: "Customer_DisplayName_NotSpecified", text: "نام مشتری خالی است" },
        { key: "Customer_Phone_NotSpecified", text: "تلفن مشتری خالی است" },
        { key: "Customer_Phones_ValueNotSpecified", text: "برای این مشتری حداقل باید یک شماره تماس ثبت شود" }
    ]);
    ...
    [
        ...
        {
            key: "User_ContactMethod_IsTooFrequentContactMethodVerification",
            text:
                "برای این اطلاعات تماس، اخیراً پیغام فعال سازی ارسال شده است. لطفاً چند دقیقه منتظر بمانید و سپس مجدداً سعی کنید"
        },
        {
            key: "User_ContactMethod_UserContactMethodVerification_ExpirationTime_VerificationDeadlineExpired",
            text: "مهلت استفاده از رمز فعال سازی به اتمام رسیده، لطفا فعال سازی را مجدداً آغاز کنید"
        },
        {
            key: "User_ContactMethod_UserContactMethodVerification_VerificationSecret_InvalidSecret",
        ...
        {
            key: "User_UserName_ValueDoesNotHaveAppropriateLength",
            text: "طول نام کاربری نباید کمتر از 4 حرف و بیشتر از 50 حرف باشد"
        },
        ...
        {
            key: "User_Password_UnexpectedError",
            text: "خطای غیرمنتظره ای در ذخیره رمز عبور اتفاق افتاده است ، پیغام خطا: {0}"
        },
        ...
        {
            key: "TooFrequentRequests",
            text: "برای این کاربر، اخیراً درخواست دیگری ثبت شده است. لطفاً بعد از چند ساعت مجدداً سعی کنید"
        },
