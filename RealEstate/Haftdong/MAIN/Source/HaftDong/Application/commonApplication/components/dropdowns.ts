module JahanJooy.HaftDong.Components {
    ...
    import ApplicationType = RealEstateAgency.Domain.Enums.UserActivity.ApplicationType;
...
//    });
    ...
    ngModule.directive('jjSelectApplicationType', () => {
        return {
            restrict: 'E',
            templateUrl: 'Application/commonApplication/components/tmpl-select-enum/application-type.html',
            scope: {
                model: '=',
                jjAllowClear: "=",
                jjRequired: '='
            ...
            controller: $scope => {
                $scope.applicationTypeOptions = EnumExtentions.getValues(ApplicationType).select(i => { return { id: i, text: Common.localization.translateEnum("ApplicationType", i) } }).toArray();
            }
        };
    });
