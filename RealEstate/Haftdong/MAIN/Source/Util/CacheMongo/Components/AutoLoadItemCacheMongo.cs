...
namespace JahanJooy.RealEstateAgency.Util.CacheMongo.Components
{
	...
	public class AutoLoadItemCacheMongo<TKey, TValue> : IItemCacheMongo<TKey, TValue>
	{
		...
		[ComponentPlug]
		public ICacheItemLoaderMongo<TKey, TValue> ItemLoader { get; set; }
