...
namespace JahanJooy.RealEstateAgency.Util.Models.Report
{
    [TsClass]
    [AutoMapperConfig]
    public class NewReportTemplateInput
    {
        ...
        {
            Mapper.CreateMap<NewReportTemplateInput, ReportTemplate>()
                .IgnoreUnmappedProperties();
            Mapper.CreateMap<ReportTemplateSummary, NewReportTemplateInput>()
                .IgnoreUnmappedProperties();
            Mapper.CreateMap<NewReportTemplateInput, ReportTemplateSummary>()
                .IgnoreUnmappedProperties();
        }
    }
}