...
namespace JahanJooy.RealEstateAgency.Api.Web.Controllers
{
    ...
    public class ReportController : ExtendedApiController
    {
        ...
        [HttpPost, Route("save")]
        [UserActivity(UserActivityType.Create, EntityType.ReportTemplate, ApplicationType.Haftdong)]
        [ApplicationAuthorize(BuiltInRoles = new[] {BuiltInRole.RealEstateAgent})]
        ...
        [ApplicationAuthorize(BuiltInRoles = new[] { BuiltInRole.RealEstateAgent })]
        [UserActivity(UserActivityType.Edit, EntityType.ReportTemplate, ApplicationType.Haftdong)]
        ...
        //        [HttpPost, Route("run/export")]
        //        public IHttpActionResult Print(ReportPrintInput input)
        //        {
        //            var report = ReportRepository.GetDirectDbConnection(input.TemplateID, input.Parameters);
        //            if (report == null)
        //                return NotFound();
        //
        //            //            report.Variables.Add();
        //
        //            StiExportFormat stiFormat;
        //            if (!Enum.TryParse(input.Format, true, out stiFormat))
        //                stiFormat = StiExportFormat.Pdf;
        //
        //            return new ReportBinaryResult(report, stiFormat);
        //        }
