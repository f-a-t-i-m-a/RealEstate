...
namespace JahanJooy.RealEstateAgency.ShishDong.Api.Local.Controllers
{
    ...
    public class AccountController : ExtendedApiController
    {
        ...
        [UserActivity(UserActivityType.Edit, EntityType.ApplicationUser, ApplicationType.Sheshdong, ActivitySubType = "ChangingPassword")]
        ...
        [UserActivity(UserActivityType.Edit, EntityType.ApplicationUser, ApplicationType.Sheshdong, ActivitySubType = "ResettingPassword")]
        ...
        [UserActivity(UserActivityType.Create, EntityType.ApplicationUser, ApplicationType.Sheshdong, ActivitySubType = "SigningUp")]
        public IHttpActionResult Signup(SignupInput input)
        {
            ...
            var result = AccountUtil.Signup(input, user, ApplicationType.Sheshdong);
        ...
        [AllowAnonymous]
        [HttpPost, Route("resetpasswordwithPasswordResetToken")]
        [UserActivity(UserActivityType.Edit, EntityType.ApplicationUser, ApplicationType.Haftdong, ActivitySubType = "resetpasswordwithPasswordResetToken")]
        public IHttpActionResult ResetPasswordWithPasswordResetToken(ResetPasswordInput input)
        {
              //UserActivityLogUtils.SetMainActivity(targetId: ObjectId.Parse(OwinRequestScopeContext.Current.GetUserId()));

            var performRecoveryResult = AccountUtil.PerformPasswordRecovery(input.UserName, input.PasswordResetToken, input.NewPassword, ApplicationType.Sheshdong);
