module JahanJooy.ShishDong.File {
    appModule.controller("FileController",
    [
        ...
        ($scope,
            ...
            scopes.store("FileController", $scope);
...
//            $scope.searchInput.SourceType = SourceType.Haftdong;
            ...
            $scope.getDataDown = (index, isCluster) => {
                ...
                $http.post("/api/haftdong/files/search", searchQuery)
                    .success((data: any) => {
            ...
            $scope.getMapData = () => {
                ...
                $http.post("/api/haftdong/files/searchinmap", searchQuery)
                    .success((data: any) => {
                        if (data == null)
                            $scope.Properties = [];
                        else
