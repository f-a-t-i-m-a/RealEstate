...
//    class RestrictToDirectiveInstance {
//        constructor(private authService) {
//        }
//
//        link(scope: ng.IScope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes) {
//            scope.$watch(attrs["restrictTo"], (value: any) => {
//                if (value != null) {
//                    if (this.authService.isAnonymous()) {
//                        element.children().remove();
//                        var loginElement =
//                            $("<a onclick=''>برای مشاهده جزئیات ابتدا باید وارد سیستم شوید</a>");
//                        loginElement.appendTo(element);
//                        return;
//                    }
//
...
//
//                    var allowedRoles: string[] = value.split(",");
//
//                    if (Enumerable.from(allowedRoles).any(ar => ar.toUpperCase() === "VERIFIEDUSER") &&
//                        !this.authService.isVerified()) {
//                        element.children().remove();
//                        var verifiedElement =
//                            $("<span>برای مشاهده جزئیات ابتدا باید اطلاعات تماس خود را تائید کنید</span>");
//                        verifiedElement.appendTo(element);
//                        return;
//                    }
//
//                    if (Enumerable.from(allowedRoles).any(ar => this.authService.isInRole(ar.trim())))
//                        accessDenied = false;
//
//                    if (accessDenied) {
//                        element.children().remove();
...
//    }
//
//    class RestrictToDirectiveDefinition implements ng.IDirective {
//        static $name = "restrictTo";
...
//            var factory = (authService) => new RestrictToDirectiveDefinition(authService);
//            factory.$inject = RestrictToDirectiveDefinition.$inject;
//            return factory;
//        }
//
//        restrict = "A";
//        link = (scope: ng.IScope, element: ng.IAugmentedJQuery, attrs: ng.IAttributes) => {
//            new RestrictToDirectiveInstance(this.authService).link(scope, element, attrs);
//        }
//    }
//
//    appModule.directive(RestrictToDirectiveDefinition.$name, RestrictToDirectiveDefinition.getFactory());
...
//                    }
    ...
    appModule.run([
        ...
        ($rootScope: ng.IRootScopeService, $state, authService, scopes) => {
    ...
    [
        "$q", "$timeout", "$injector",
        ($q: ng.IQService, $timeout: ng.ITimeoutService, $injector) => {
