...
angular.module("ui.bootstrap.persian.datepicker", ["ui.bootstrap.dateparser", "ui.bootstrap.position", "ui.bootstrap.persian.datepicker.tpls", "persianDate"])
    ...
    .controller("ui.bootstrap.persian.datepicker.DatepickerController", [
        "$scope", "$attrs", "$parse", "$interpolate", "$timeout", "$log", "dateFilter", "datepickerConfig", "PersianDateService", "persianDateFilter", function($scope, $attrs, $parse, $interpolate, $timeout, $log, dateFilter, datepickerConfig, PersianDateService, persianDateFilter) {
            var self = this,
    ...
    .directive("persianDaypicker", [
        "dateFilter", "PersianDateService", "persianDateFilter", function(dateFilter, PersianDateService, persianDateFilter) {
            return {
                restrict: "EA",
                replace: true,
                ...
                link: function(scope, element, attrs, ngModel) {
                    ...
                    function parseDate(viewValue) {
                        ...
                        if (/^\d\d[\/-]/.test(viewValue)) {
                            viewValue = "13" + viewValue;
                        }

                        if (angular.isString(viewValue)) {
                            var m = moment(viewValue, dateFormat);
                            if (!m.isValid()) {
                    ...
                    ngModel.$render = function() {
                        ...
                        var date = ngModel.$viewValue ? moment(ngModel.$viewValue).format(dateFormat) : "";
